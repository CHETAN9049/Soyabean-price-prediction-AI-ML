...
def select_dropdown_and_submit(page, year, month, context):
    try:
        logger.info(f"Processing Soyabean Month={month} Year={year}")
        ...
        page.select_option(commodity_selector, value="13")  
        time.sleep(0.5)
        ...
        file_name = f"soyabean_{year}_{month}.html"
...
def main():
    ...
    if all_data:
        ...
        output_file = "Soyabean_Prices_Normalized.xlsx"
