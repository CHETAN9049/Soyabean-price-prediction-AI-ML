...
input_file = os.path.join(output_dir, 'Groundnut_Prices_Normalized.xlsx')
output_file = os.path.join(output_dir, 'Groundnut_Prices_Cleaned_Origin.csv')
...
if not os.path.exists(input_file):
    raise FileNotFoundError(
        ...
        f"Please ensure 'Groundnut_Prices_Normalized.xlsx' is in {output_dir} "
